                          ...
                          >
                            ...
                            >
                              ...
                              <div className="flex items-center space-x-1.5 flex-shrink-0 ml-2">
                                ...
                                {/* Not Done (active state - click to reopen / move back to Pending) */}
                                <button
                                  type="button"
                                  onClick={(e) => { e.stopPropagation(); handleReopen(task); }}
                                  disabled={isProcessing}
                                  title="Marked as Not Done · Click to reopen / move back to Pending"
                                  className="flex items-center space-x-1 px-2 py-1 rounded-lg bg-rose-500/20 border border-rose-500/35 text-rose-300 hover:bg-rose-500/30 text-[10px] font-semibold transition-colors cursor-pointer disabled:opacity-50"
                                >
                                  <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                                  </svg>
                            ...
                            {expandedId === task.id && (
                              <div className="px-3 pb-3 border-t border-rose-500/[0.1] animate-fade-in">
                                ...
                                <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-rose-500/[0.1]">
                                  <div className="flex items-center space-x-2">
                                    <button
                                      type="button"
                                      onClick={(e) => { e.stopPropagation(); handleMarkDone(task); }}
                                    ...
                                    <button
                                      ...
                                      className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg bg-indigo-500/20 border border-indigo-500/30 text-indigo-300 hover:bg-indigo-500/30 text-[11px] font-semibold transition-colors cursor-pointer disabled:opacity-50"
                                    >
                                      <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                                  ...
                                  <div className="flex items-center space-x-1.5">
                                    <button
                                      ...
                                      disabled={isProcessing}
                                      title="Jump to date"
                                      className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg bg-violet-500/15 border border-violet-500/25 text-violet-300 hover:bg-violet-500/25 text-[11px] font-medium transition-colors cursor-pointer disabled:opacity-50"
                                    >
                                      <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                      </svg>
