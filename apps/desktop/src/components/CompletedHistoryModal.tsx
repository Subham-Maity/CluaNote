                          ...
                          >
                            ...
                            >
                              ...
                              <div className="flex items-center space-x-1 flex-shrink-0 ml-2">
                                {/* Done (completed active state - click to unmark / revert to Pending) */}
                                <button
                                  type="button"
                                  onClick={(e) => { e.stopPropagation(); removeAndUpdate(task, () => setTaskStatus(task.id, 0)); }}
                                  disabled={isProcessing}
                                  title="Completed · Click to revert to Pending"
                                  className="flex items-center space-x-1 px-2 py-1 rounded-lg bg-emerald-500/20 border border-emerald-500/35 text-emerald-300 hover:bg-emerald-500/30 text-[10px] font-semibold transition-colors cursor-pointer disabled:opacity-50"
                                >
                                ...
                                <button
                                  ...
                                  className="flex items-center space-x-1 px-2 py-1 rounded-lg bg-rose-500/15 border border-rose-500/30 text-rose-300 hover:bg-rose-500/25 text-[10px] font-medium transition-colors cursor-pointer disabled:opacity-50"
                                >
                                  <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                                ...
                                <button
                                  ...
                                  disabled={isProcessing}
                                  title="Delete task"
                                  className="w-6 h-6 rounded-lg flex items-center justify-center text-white/40 hover:text-rose-400 hover:bg-rose-500/10 transition-colors cursor-pointer disabled:opacity-50"
                                >
                            ...
                            {isExpanded && (
                              <div className="px-3 pb-3 border-t border-emerald-500/[0.1] animate-fade-in">
                                ...
                                <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-emerald-500/[0.1]">
                                  <div className="flex items-center space-x-2">
                                    <button
                                      type="button"
                                      onClick={(e) => { e.stopPropagation(); removeAndUpdate(task, () => setTaskStatus(task.id, 0)); }}
                                      ...
                                      className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg bg-amber-500/20 border border-amber-500/30 text-amber-300 hover:bg-amber-500/30 text-[11px] font-semibold transition-colors cursor-pointer disabled:opacity-50"
                                    >
                                      <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                                    ...
                                    <button
                                      ...
                                      disabled={isProcessing}
                                      title="Mark as Not Done"
                                      className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg bg-rose-500/20 border border-rose-500/30 text-rose-300 hover:bg-rose-500/30 text-[11px] font-semibold transition-colors cursor-pointer disabled:opacity-50"
                                    >
                                      <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                                      </svg>
                                  ...
                                  <div className="flex items-center space-x-1.5">
                                    <button
                                      ...
                                      disabled={isProcessing}
                                      title="Jump to date"
                                      className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg bg-indigo-500/15 border border-indigo-500/25 text-indigo-300 hover:bg-indigo-500/25 text-[11px] font-medium transition-colors cursor-pointer disabled:opacity-50"
                                    >
                                      <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                      </svg>
                                    ...
                                    <button
                                      ...
                                      disabled={isProcessing}
                                      title="Delete task"
                                      className="p-1.5 rounded-lg text-white/40 hover:text-rose-400 hover:bg-rose-500/15 border border-transparent hover:border-rose-500/30 transition-colors cursor-pointer disabled:opacity-50"
                                    >
                                      <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                      </svg>
