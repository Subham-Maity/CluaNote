                          ...
                          >
                            ...
                            >
                              ...
                              <div className="flex items-center space-x-1 flex-shrink-0 ml-2">
                                <button
                                  ...
                                  title="Mark as done"
                                  className="flex items-center space-x-1 px-2 py-1 rounded-lg bg-emerald-500/15 border border-emerald-500/30 text-emerald-300 hover:bg-emerald-500/25 text-[10px] font-medium transition-colors cursor-pointer disabled:opacity-50"
                                >
                            ...
                            {isExpanded && (
                              <div className="px-3 pb-3 border-t border-white/[0.05] animate-fade-in">
                                ...
                                <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-white/[0.07]">
                                  <div className="flex items-center space-x-2">
                                    <button
                                      type="button"
                                      onClick={(e) => { e.stopPropagation(); handleMarkDone(task); }}
                                      disabled={isProcessing}
                                      className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg bg-emerald-500/20 border border-emerald-500/30 text-emerald-300 hover:bg-emerald-500/30 text-[11px] font-semibold transition-colors cursor-pointer disabled:opacity-50"
                                    >
                                      <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                                      </svg>
